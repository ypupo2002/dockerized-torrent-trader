...
$site_config['SITEEMAIL'] = 'tracker@datys.cu';		//Emails will be sent from this address
$site_config['SITEURL'] = $_ENV["site_url"];	//Main Site URL
...
$site_config['announce_list'] = $_ENV["site_url"].'/announce.php'; //seperate via comma
...
$site_config['PASSKEYURL'] =  $_ENV["site_url"].'/announce.php?passkey=%s'; // Announce URL to use for passkey
$site_config['UPLOADSCRAPE'] = true; // Scrape external torrents on upload? If using mega-scrape.php you should disable this
$site_config['FORUMS'] = false; // Enable / Disable Forums
...
$site_config["mail_smtp_host"] = "correo.datys.cu"; // SMTP server hostname
...
$site_config["mail_smtp_user"] = "tracker@datys.cu"; // SMTP username
